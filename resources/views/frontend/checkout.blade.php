...
.input-c>i:hover, a[role="button"]:hover {
  color: #777;
}
.amount-placeholder {
  font-size: 20px;
...
.cvc-preview-c.two-card div {
  width: 48%;
  height: 80px;
}

.cvc-preview-c.two-card div.amex-cvc-preview {
  float: right;
}

.cvc-preview-c.two-card div.visa-mc-dis-cvc-preview {
  float: left;
}
      ...
      <form action="{{url('checkout-order')}}" method="POST" enctype="multipart/form-data">
        @csrf
          ...
          <div class="form-group">
              ...
              <input id="NameOnCard" name="name_card" class="form-control" type="text" maxlength="255">
          </div>
          <div class="form-group">
              <label for="CreditCardNumber">Card number</label>
              <input id="CreditCardNumber" name="num_card" class="null card-image form-control" type="text">
          </div>
          <div class="expiry-date-group form-group">
              <label for="ExpiryDate">Expiry date</label>
              <input id="ExpiryDate" name="date_card" class="form-control" type="text" placeholder="MM / YY" maxlength="7">
          </div>
          <div class="security-code-group form-group">
              <label for="SecurityCode">Security code</label>
              <div class="input-container" >
                  <input id="SecurityCode" name="cvv" class="form-control" type="text" >
          ...
          <button id="PayButton" class="btn btn-block btn-success submit-button mt-2" type="submit">
              <span class="submit-button-lock"></span>
              <span class="align-middle">Pay {{$total}} $</span>
          </button>
      </form>
  </div>
</div>
